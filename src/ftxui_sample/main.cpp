...
// configuration step. It creates a namespace called `cvims_client`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cvims_client::cmake::project_name, cvims_client::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cvims_client::cmake::project_version);
      return EXIT_SUCCESS;
    }
